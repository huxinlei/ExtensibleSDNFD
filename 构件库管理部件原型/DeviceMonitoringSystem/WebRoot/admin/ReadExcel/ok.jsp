...
<HTML>
	<HEAD>
		...
		<meta http-equiv="Refresh"
			content="5;URL=${pageContext.request.contextPath}/Part-getAllUtil.action">
	</HEAD>
	<BODY
					...
					<TR
						...
						<TD>
							<SPAN
								...
								<spring:message code="fle_a_13" /> </SPAN><SPAN
							...
							<DIV align=middle>
								<table width="100%" border="0">
									<tr align="left">
										...
										<a href="${pageContext.request.contextPath}/Policy-getAllUtil.action">&nbsp;这&nbsp;里&nbsp;</a>
