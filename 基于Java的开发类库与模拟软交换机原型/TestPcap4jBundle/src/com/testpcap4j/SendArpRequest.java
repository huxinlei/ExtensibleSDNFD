...
public class SendArpRequest {
	...
	private static final MacAddress SRC_MAC_ADDR
	  = MacAddress.getByName("ff:ae:1d:20:92:72");
	private static MacAddress resolvedAddr;
	
	private SendArpRequest(){}
	
	public static void main(String[] args) throws PcapNativeException,NotOpenException{
		String strSrcIpAddress = "183.175.13.141";//for InetAddress.getByName()
		String strDstIpAddress = "183.175.13.137";//for InetAddress.getByName()
