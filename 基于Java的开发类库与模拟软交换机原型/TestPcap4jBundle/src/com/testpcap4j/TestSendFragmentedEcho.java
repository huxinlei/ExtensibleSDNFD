...
public class TestSendFragmentedEcho {
	  private static final String COUNT_KEY
	    = TestSendFragmentedEcho.class.getName() + ".count";
	  private static final int COUNT
	    = Integer.getInteger(COUNT_KEY, 3);

	  private static final String READ_TIMEOUT_KEY
	    = TestSendFragmentedEcho.class.getName() + ".readTimeout";
	  private static final int READ_TIMEOUT
	    = Integer.getInteger(READ_TIMEOUT_KEY, 10); // [ms]

	  private static final String SNAPLEN_KEY
	    = TestSendFragmentedEcho.class.getName() + ".snaplen";
	  private static final int SNAPLEN
	    = Integer.getInteger(SNAPLEN_KEY, 65536); // [bytes]

	  private static final String TU_KEY
	    = TestSendFragmentedEcho.class.getName() + ".tu";
	  private static final int TU
	    = Integer.getInteger(TU_KEY, 4000); // [bytes]

	  private static final String MTU_KEY
	    = TestSendFragmentedEcho.class.getName() + ".mtu";
	  private static final int MTU
	    = Integer.getInteger(MTU_KEY, 1403); // [bytes]
	  
	  private TestSendFragmentedEcho(){}
	  
	  public static void main(String[] args) throws PcapNativeException {
		  String strSrcIpAddress = "183.175.13.141";
		  String strSrcMacAddress = "ff:ae:1d:20:92:72";
		  String strDstIpAddress = "183.175.13.137";
		  String strDstMacAddress = "ff:ff:ff:ff:ff:ff";
