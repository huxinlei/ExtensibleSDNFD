...
public class TestSendArpRequest {
	...
	private static final MacAddress SRC_MAC_ADDR
	  = MacAddress.getByName("88:ae:1d:20:92:71");
	private static MacAddress resolvedAddr;
	
	private TestSendArpRequest(){}
	
	public static void main(String[] args) throws PcapNativeException,NotOpenException{
		String strSrcIpAddress = "192.168.28.1";//for InetAddress.getByName()
		String strDstIpAddress = "192.168.28.137";//for InetAddress.getByName()
